...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FacultyList',
            fields=[
                ('fid', models.ForeignKey(db_column='fid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='hod.CamsLogin')),
        ...
        migrations.CreateModel(
            name='StudentList',
            fields=[
                ('usn', models.ForeignKey(db_column='usn', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='hod.CamsLogin')),
                ('name', models.CharField(max_length=30)),
        ...
        migrations.CreateModel(
            name='TestNo',
            fields=[
                ('tid', models.ForeignKey(db_column='tid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='hod.TestId')),
                ('scode', models.CharField(max_length=8)),
            ],
            options={
                'managed': False,
